...
protocol SelectorType {
    ...
    ///  - Parameters fileDescriptor: the file descriptor to watch
    ///  - Parameters events: IO events to watch
    ///  - Parameters data: user custom data to be returned when we see an IO event
    ...
    ///  - Parameters timeout: how long time to wait until return empty list,
